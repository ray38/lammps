...
GMP::GMP(LAMMPS* lmp, double rfac0_in, int twojmax_in,
...
void GMP::compute_ui(int jnum, int ielem)
{
...
void GMP::compute_yi(const double* beta)
{
  int jju;
  double betaj;
  int itriple;
...
void GMP::compute_deidrj(double* dedr)
{
...
void GMP::compute_duidrj(int jj)
{
...
void GMP::zero_uarraytot(int ielem)
{
...
void GMP::add_uarraytot(double r, int jj)
{
  double sfac;
  int jelem;
...
void GMP::compute_uarray(double x, double y, double z,
...
void GMP::compute_duarray(double x, double y, double z,
...
void GMP::create_twojmax_arrays()
{
  int jdimpq = twojmax + 2;
...
void GMP::destroy_twojmax_arrays()
{
...
double GMP::deltacg(int j1, int j2, int j)
{
...
double GMP::compute_sfac(double r, double rcut, double sinner, double dinner)
{
  double sfac;
...
double GMP::compute_dsfac(double r, double rcut, double sinner, double dinner)
{
